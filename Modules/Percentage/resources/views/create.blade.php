    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                <div class="card-body">
                    <form action="{{ route('percentage.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-xl-3">
                                <div class="col-xl-12 mb-4">
                                    ...
                                    <input type="text" class="form-control @error('input1') is-invalid @enderror"
                                        ...
                                        name="input1" value="{{ old('input1') }}" required>
                                    @error('input1')
                                ...
                                <div class="col-xl-12 mb-4">
                                    ...
                                    <input type="text" class="form-control @error('input2') is-invalid @enderror"
                                        ...
                                        name="input2" value="{{ old('input2') }}" required>
                                    @error('input1')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                @if (Session::has('data'))
                                    <div class="col-xl-12 mb-4">
                                        ...
                                        <input type="text" class="form-control"
                                            ...
                                            name="result" value="{{ Session::get('data')['result'] }}%" disabled>
                                    </div>
                                    <div class="col-xl-12 mb-4">
                                        <label for="inputremark" class="form-label">
                                            Pesan
                                        ...
                                        name="message" value="{{ Session::get('data')['message'] }}" disabled>
                                    @php
                                        Session::forget('data');
                                    @endphp
                                    </div>
